...
export default function CartPage() {
  ...
  return (
    <section className="bg-primary mx-auto min-h-screen w-full rounded-lg p-6 text-white shadow-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 md:flex-row">
            ...
            <div className="flex gap-4">
              <Link href="/products">
                <Button variant="outline" className="curosr-pointer text-black">
                  Continue Shopping
                </Button>
              </Link>
              <Link href="/checkout">
